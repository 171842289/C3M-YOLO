...
def run(
        ...
        name='exp_Yolov5',  # save to project/name
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'datasets/IP102/ip102.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='exp_Yolov5', help='save to project/name')
